...
<!-- ************************** NAVBAR START ************************** -->
<nav class="reltive navbar navbar-expand-lg navbar-light bg-primary"><!-- This line creates a div called nav, this holds the parameters for the div including themes -->
    <div class="container"><!-- This opens a new div within the nav div and uses the class 'container' which is a css held within the bootstrap css files -->
      ...
      <div class="collapse navbar-collapse" id="navbarsExample07"><!-- This line creates a new div within the nav div and sets the parameters -->
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-6"><!-- This line is creating an unordered list div and setting the parameters and theme etc.. -->
          <li class="nav-item"><!-- This line creates a line within the list -->
            <a class="nav-link" aria-current="page" href="Account/sign_up.php"><b>Register</b></a><!-- This is the link that users can click to navigate to the Registry page -->
          ...
          <li class="nav-item"><!-- This line creates a line within the list -->
            <a class="nav-link" href="" data-bs-toggle="modal" data-bs-target="#login"><b>Sign In</b></a><!-- This creates a line within the new list that is linked to the 'Sign In' page. the data-bs-target is the id of the paragraph of code within the modal page. when the user clicks the link the 'Sign In' modal will pop up. -->
          </li><!-- This closes the line -->
...
<div class="p-3 fs-1 text-primary-emphasis bg-info-subtle border border-primary-subtle rounded-3 text-center"><!--This line creates a new div with included parameters -->
