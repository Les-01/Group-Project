...
$dbuser = "Charles"; // Variable 'dbuser' database user and that's me so it has my name as i created an account on the server with all permissions
$dbpass = "12345678"; // Variable 'dbpass' which means database password, this is the email used for the user (me).
