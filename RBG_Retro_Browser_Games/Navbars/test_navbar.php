    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample07">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item"> 
           <a class="nav-link" href=../test_page.php><B>Test Page</B></a></li>
          </li>
          <li class="nav-item">
        ...
        <li class="nav-item dropdown">
           <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Tester Options</a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="upload.php">Image Upload</a></li>
