...
// This declares the 'const' type variable 'GRID_SIZE' and assigns its value.
const GRID_SIZE = 21
...
export function randomGridPosition() {
    return {
        ...
        // between 0 and 1. Whereas Math.random used with Math.floor generates whole numbers. Here a random number would be generated between 0 and the value of the variable GRID_SIZE. 
