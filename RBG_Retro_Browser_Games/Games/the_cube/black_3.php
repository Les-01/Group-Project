...
<html>
    <head>
        ...
        <script>
            ...
            // This declares the const type variable 'myLink' and uses the 'getElementById' method to find the element with the id 'myLink' and assign to the variable 'myLink'.
            const myLink = document.getElementById('myLink');
            // This is an event listener listening for the 'keydown' event.
            document.addEventListener('keydown', function(event) 
            {
                // 'IF' the '`' key is pressed execute the code within the code block.
    ...
    <body>
        <div>
            ...
            <!--------------------  Game Image  -------------------->
            <img src="images/black_3.jpg" alt="Left And Right Junction In The Cube">
            <!--------------------  Game Text  -------------------->
            ...
            <div class="play_button_div ">
                <a id="button1" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="black_play_button">Left</button></a>
                <a id="button2" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="black_play_button">Right</button></a>
                <a id="button3" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="black_play_button">Up</button></a>
                <a id="button4" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="black_play_button">Down</button></a>
                <a id="button5" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="black_play_button">Forward</button></a>
                <a id="button6" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="black_play_button">Back</button></a>
