<?php
    ...
    // This 'IF' statement declares that if the submit button has been used to access 'noughts_and_crosses_score_process.php' execute the code within the 'IF' statement.
    if(isset($_POST['submit']))
    {
        // This assigns the values POSTED to 'noughts_and_crosses_score_process.php' using '$_POST' method to the variables to be passed on to a function.
    ...
    // If the user gained access to 'noughts_and_crosses_score_process.php' without using the submit button execute the code within the 'ELSE' statement.
    else {
        // This redirects the user to the 'noughts and crosses game.
