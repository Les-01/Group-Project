...
<html>
    ...
    <body>
        <div>
            ...
            <!--------------------  Game Image  -------------------->
            <img src="images/blue_1.png" alt="Left And Right Junction In The Cube">
            <!--------------------  Game Text  -------------------->
            ...
            <div class="play_button_div ">
                <a id="button1" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="blue_play_button">Left</button></a>
                <a id="button2" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="blue_play_button">Right</button></a>
                <a id="button3" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="blue_play_button">Up</button></a>
                <a id="button4" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="blue_play_button">Down</button></a>
                <a id="button5" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="blue_play_button">Forward</button></a>
                <a id="button6" href="#" onclick="document.cookie = 'minutes='+Min; document.cookie = 'seconds='+Sec;"><button class="blue_play_button">Back</button></a>
