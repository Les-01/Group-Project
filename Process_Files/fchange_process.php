...
$NewFname = $_POST['new_fname']; //This is creating a new variable '$NewFname' and populating this element with the posted variable '$_POST['new_fname']


if (!empty($Username) && !empty($NewFname) && !empty($Password)) // This line here is checking that the fields aren't empty and ensuring the username doesn't contian numbers. '!' mens not. so the method '!empty($user_Name)' is saying field 'User_Name' is not empty.
    {//This opens the if statement
       ...
       { //This opens the if statement
          ...
          { //This opens the if statement
              ...
              { //This opens the if statement
                ...
                $query = "UPDATE `user_tbl` SET `Fname` = '" .$NewFname. "'  WHERE `User_ID` LIKE '" .$User_Data['User_ID']. "'"; //This will update the DB at the location provided.
